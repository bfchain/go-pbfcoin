...
func (t *BlockTest) InsertPreState(db pbfdb.Database, am *accounts.Manager) (*state.StateDB, error) {
...
/* See https://github.com/pbfcoin/tests/wiki/Blockchain-Tests-II

   Whpbfer a block is valid or not is a bit subtle, it's defined by presence of
