...
// Tests whpbfer a message can be wrapped without any identity or encryption.
...
// Tests whpbfer a message can be signed, and wrapped in plain-text.
...
// Tests whpbfer a message can be encrypted and decrypted using an anonymous
...
// Tests whpbfer a message can be properly signed and encrypted.
