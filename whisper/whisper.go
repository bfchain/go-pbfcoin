...
import (
	...
	"github.com/pbfcoin/go-pbfcoin/event/filter"
...
// Whisper represents a dark communication interface through the pbfcoin
...
type Whisper struct {
	...
	expirations map[uint32]*set.SetNonTS  // Message expiration pool (TODO: sompbfing lighter)
...
// New creates a Whisper client ready to communicate through the pbfcoin P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
