...
/*
    This file is part of pbfcoin.js.

    pbfcoin.js is free software: you can redistribute it and/or modify
    it under the terms of the GNU Lesser General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    pbfcoin.js is distributed in the hope that it will be useful,
    but WITHOUT ANY WARRANTY; without even the implied warranty of
    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
    GNU Lesser General Public License for more details.

    You should have received a copy of the GNU Lesser General Public License
    along with pbfcoin.js.  If not, see <http://www.gnu.org/licenses/>.
*/
/**
 * @file coder.js
 * @author Marek Kotewicz <marek@pbfdev.com>
 * @date 2015
 */
...
/**
 * This method should be used to combine solidity params togpbfer
...
/** @file config.js
 * @authors:
 *   Marek Kotewicz <marek@pbfdev.com>
 * @date 2015
 */
...
module.exports = function (str, isNew) {
    if (str.substr(0, 2) === '0x' && !isNew) {
        ...
        console.warn('see https://github.com/pbfcoin/web3.js/pull/205');
...
var unitMap = {
    ...
    'gwei':         '1000000000',
    'shannon':      '1000000000',
    'nanopbfer':    '1000000000',
    'nano':         '1000000000',
    'szabo':        '1000000000000',
    'micropbfer':   '1000000000000',
    'micro':        '1000000000000',
    'finney':       '1000000000000000',
    'millipbfer':    '1000000000000000',
    'milli':         '1000000000000000',
    'pbfer':        '1000000000000000000',
    'kpbfer':       '1000000000000000000000',
    'grand':        '1000000000000000000000',
    'einstein':     '1000000000000000000000',
    'mpbfer':       '1000000000000000000000000',
    'gpbfer':       '1000000000000000000000000000',
    'tpbfer':       '1000000000000000000000000000000'
};
 ...
 * @param {String} unit the unit to convert to, default pbfer
 * @returns {BigNumber} value of the unit (in Wei)
 * @throws error if the unit is not correct:w
 */
var getValueOfUnit = function (unit) {
    unit = unit ? unit.toLowerCase() : 'pbfer';
...
/**
 * Takes a number of wei and converts it to any other pbfer unit.
 *
 * Possible units are:
 *   SI Short   SI Full        Effigy       Other
 * - kwei       femtopbfer     ada
 * - mwei       picopbfer      babbage
 * - gwei       nanopbfer      shannon      nano
 * - --         micropbfer     szabo        micro
 * - --         millipbfer     finney       milli
 * - pbfer      --             --
 * - kpbfer                    einstein     grand
 * - mpbfer
 * - gpbfer
 * - tpbfer
 *
 ...
 * @param {String} unit the unit to convert from, default pbfer
 * @return {String|Object} When given a BigNumber object it returns one as well, otherwise a number
*/
...
/** @file web3.js
 * @authors:
 *   Jeffrey Wilcke <jeff@pbfdev.com>
 *   Marek Kotewicz <marek@pbfdev.com>
 *   Marian Oancea <marian@pbfdev.com>
 *   Fabian Vogelsteller <fabian@pbfdev.com>
 *   Gav Wood <g@pbfdev.com>
 * @date 2014
 */

var version = require('./version.json');
var net = require('./web3/methods/net');
var pbf = require('./web3/methods/pbf');
...
web3.pbf.isSyncing = function (callback) {
    return new IsSyncing(callback);
};

/*jshint maxparams:4 */
web3.pbf.filter = function (fil, callback) {
    return new Filter(fil, watches.pbf(), formatters.outputLogFormatter, callback);
};
/*jshint maxparams:3 */
...
// ADD defaultblock
Object.defineProperty(web3.pbf, 'defaultBlock', {
    get: function () {
...
Object.defineProperty(web3.pbf, 'defaultAccount', {
    get: function () {
...
setupmethods(web3.pbf, pbf.methods);
setupProperties(web3.pbf, pbf.properties);
...
AllSolidityEvents.prototype.execute = function (options, callback) {
    ...
    return new Filter(o, watches.pbf(), formatter, callback);
};
...
var checkForContractAddress = function(contract, abi, callback){
    ...
    // wait for receipt
    var filter = web3.pbf.filter('latest', function(e){
        if(!e && !callbackFired) {
            count++;
            ...
            if(count > 50) {
                ...
                web3.pbf.getTransactionReceipt(contract.transactionHash, function(e, receipt){
                    if(receipt && !callbackFired) {

                        web3.pbf.getCode(receipt.contractAddress, function(e, code){
                            /*jshint maxcomplexity: 5 */
...
ContractFactory.prototype.new = function () {
    ...
    if(callback) {
        ...
        web3.pbf.sendTransaction(options, function (err, hash) {
            if (err) {
                callback(err);
            } else {
        ...
        var hash = web3.pbf.sendTransaction(options);
        // add the transaction hash
        contract.transactionHash = hash;
 ...
 * @return {Object} everything combined togpbfer and encoded
 */
 ...
 * @file formatters.js
 * @author Marek Kotewicz <marek@pbfdev.com>
 * @author Fabian Vogelsteller <fabian@pbfdev.com>
 * @date 2015
 */
...
SolidityFunction.prototype.call = function () {
    ...
    if (!callback) {
        var output = web3.pbf.call(payload, defaultBlock);
        return this.unpackOutput(output);
    }

    var self = this;
    web3.pbf.call(payload, defaultBlock, function (error, output) {
...
SolidityFunction.prototype.sendTransaction = function () {
    ...
    if (!callback) {
        return web3.pbf.sendTransaction(payload);
    }

    web3.pbf.sendTransaction(payload, callback);
};
...
SolidityFunction.prototype.estimateGas = function () {
    ...
    if (!callback) {
        return web3.pbf.estimateGas(payload);
    }

    web3.pbf.estimateGas(payload, callback);
};
...
/**
 * This method should be used to create iban object from pbfcoin address
 *
 * @method fromAddress
 * @param {String} address
...
Iban.createIndirect = function (options) {
    return Iban.fromBban('pbf' + options.institution + options.identifier);
};
...
Iban.prototype.isValid = function () {
    return /^XE[0-9]{2}(pbf[0-9A-Z]{13}|[0-9A-Z]{30,31})$/.test(this._iban) &&
...
var methods = [
    putString, getString, putHex, gpbfex
];
...
/// @returns an array of objects describing web3.pbf api methods
...
/// @returns an array of objects describing web3.pbf api properties
...
/// @returns an array of objects describing web3.pbf.filter api methods
var pbf = function () {
 ...
 * @author Jeffrey Wilcke <jeff@pbfdev.com>
 * @author Marek Kotewicz <marek@pbfdev.com>
 * @author Marian Oancea <marian@pbfdev.com>
 * @author Fabian Vogelsteller <fabian@pbfdev.com>
 * @author Gav Wood <g@pbfdev.com>
 * @date 2014
 */
 ...
 * It's also responsible for polling the pbfcoin node for incoming messages
...
var transferToAddress = function (from, to, value, callback) {
    return web3.pbf.sendTransaction({
        address: to,
        from: from,
        value: value
    }, callback);
...
;(function (root, factory) {
	...
	var CryptoJS = CryptoJS || (function (Math, undefined) {
	    ...
	    var BufferedBlockAlgorithm = C_lib.BufferedBlockAlgorithm = Base.extend({
	         ...
	         *
	         * @param {boolean} doFlush Whpbfer all blocks and partial blocks should be processed.
	         *
...
web3.pbf.contract = require('./lib/web3/contract');
web3.pbf.namereg = namereg.namereg;
web3.pbf.ibanNamereg = namereg.ibanNamereg;
web3.pbf.sendIBANTransaction = require('./lib/web3/transfer');
web3.pbf.iban = require('./lib/web3/iban');
