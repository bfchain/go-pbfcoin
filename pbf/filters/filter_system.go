...
// package filters implements an pbfcoin filtering system for block,
...
// for specific LOG events fired by the EVM (pbfcoin Virtual Machine).
...
// filterLoop waits for specific events from pbfcoin and fires their handlers
