...
var ProtocolName = "pbf"

// Supported versions of the pbf protocol (first is primary).
var ProtocolVersions = []uint{pbf63, pbf62, pbf61}
...
// pbf protocol message codes
const (
	// Protocol messages belonging to pbf/61
	StatusMsg                   = 0x00
	...
	// Protocol messages belonging to pbf/62 (new protocol from scratch)
	// StatusMsg          = 0x00 (uncomment after pbf/61 deprecation)
	// NewBlockHashesMsg  = 0x01 (uncomment after pbf/61 deprecation)
	// TxMsg              = 0x02 (uncomment after pbf/61 deprecation)
	GetBlockHeadersMsg = 0x03
	BlockHeadersMsg    = 0x04
	GetBlockBodiesMsg  = 0x05
	BlockBodiesMsg     = 0x06
	// 	NewBlockMsg       = 0x07 (uncomment after pbf/61 deprecation)

	// Protocol messages belonging to pbf/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
