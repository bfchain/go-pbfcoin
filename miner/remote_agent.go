...
type RemoteAgent struct {
	...
	running int32 // running indicates whpbfer the agent is active. Call atomically
}
...
// GpbfashRate returns the accumulated hashrate of all identifier combined
func (a *RemoteAgent) GpbfashRate() (tot int64) {
	a.hashrateMu.RLock()
...
func (a *RemoteAgent) GetWork() ([3]string, error) {
	...
	if a.currentWork != nil {
		...
		seedHash, _ := pbfash.GetSeedHash(block.NumberU64())
