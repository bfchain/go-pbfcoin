...
// a block's data contents (transactions and uncles) togpbfer.
type Body struct {
...
type Block struct {
	...
	// ReceivedAt is used by package pbf to track block propagation time.
...
// [deprecated by pbf/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for pbf protocol, etc.
