...
// genTxRing returns a block generator that sends pbfer in a ring
...
func benchInsertChain(b *testing.B, disk bool, gen func(int, *BlockGen)) {
	...
	var db pbfdb.Database
	if !disk {
		db, _ = pbfdb.NewMemDatabase()
	} else {
		dir, err := ioutil.TempDir("", "pbf-core-bench")
		if err != nil {
			b.Fatalf("cannot create temporary directory: %v", err)
		}
		defer os.RemoveAll(dir)
		db, err = pbfdb.NewLDBDatabase(dir, 0)
		if err != nil {
