...
func WriteGenesisBlock(chainDb pbfdb.Database, reader io.Reader) (*types.Block, error) {
...
func GenesisBlockForTesting(db pbfdb.Database, addr common.Address, balance *big.Int) *types.Block {
...
func WriteGenesisBlockForTesting(db pbfdb.Database, accounts ...GenesisAccount) *types.Block {
	accountJson := "{"
...
func WriteTestNetGenesisBlock(chainDb pbfdb.Database, nonce uint64) (*types.Block, error) {
	testGenesis := fmt.Sprintf(`{
        "nonce": "0x%x",
        "difficulty": "0x20000",
...
func WriteOlympicGenesisBlock(chainDb pbfdb.Database, nonce uint64) (*types.Block, error) {
	testGenesis := fmt.Sprintf(`{
	"nonce":"0x%x",
	"gasLimit":"0x%x",
	"difficulty":"0x%x",
