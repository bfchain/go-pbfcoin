...
func NewStateObject(address common.Address, db pbfdb.Database) *StateObject {
...
func NewStateObjectFromBytes(address common.Address, data []byte, db pbfdb.Database) *StateObject {
