...
func makeTestState() (pbfdb.Database, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db pbfdb.Database, root common.Hash, accounts []*testAccount) {
	state, _ := New(root, db)
