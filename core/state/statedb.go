...
// StateDBs within the pbfcoin protocol are used to store anything
...
func New(root common.Hash, db pbfdb.Database) (*StateDB, error) {
...
// NewStateObject create a state object whpbfer it exist in the trie or not
...
func (s *StateDB) CommitBatch() (root common.Hash, batch pbfdb.Batch) {
	batch = s.db.NewBatch()
