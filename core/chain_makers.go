...
func (f FakePow) Gpbfashrate() int64          { return 0 }
...
func GenerateChain(parent *types.Block, db pbfdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
...
// header only chain.
func newCanonical(n int, full bool) (pbfdb.Database, *BlockChain, error) {
...
func makeHeaderChain(parent *types.Header, n int, db pbfdb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, db pbfdb.Database, seed int) []*types.Block {
