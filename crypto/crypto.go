...
import (
	...
	"github.com/pbfcoin/go-pbfcoin/crypto/ecies"
	"github.com/pbfcoin/go-pbfcoin/crypto/secp256k1"
...
// Creates an pbfcoin address given the bytes and the nonce
...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/pbfcoin/pypbfsaletool

		pypbfsaletool generates the encryption key from password by
	...
	*/
	...
	pbfPriv := Sha3(plainText)
	ecKey := ToECDSA(pbfPriv)
	key = &Key{
		Id:         nil,
		Address:    PubkeyToAddress(ecKey.PublicKey),
		PrivateKey: ecKey,
	...
	expectedAddr := preSaleKeyStruct.pbfAddr
