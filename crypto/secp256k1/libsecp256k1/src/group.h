...
typedef struct {
    secp256k1_fe x;
    secp256k1_fe y;
    int infinity; /* whpbfer this represents the point at infinity */
} secp256k1_ge;
 ...
 *  for Y. Return value indicates whpbfer the result is valid. */
static int secp256k1_ge_set_xo_var(secp256k1_ge *r, const secp256k1_fe *x, int odd);

/** Check whpbfer a group element is the point at infinity. */
static int secp256k1_ge_is_infinity(const secp256k1_ge *a);

/** Check whpbfer a group element is valid (i.e., on the curve). */
