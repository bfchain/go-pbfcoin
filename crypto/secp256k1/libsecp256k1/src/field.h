...
/** Verify whpbfer a field element represents zero i.e. would normalize to a zero value. The field
...
/** Verify whpbfer a field element is zero. Requires the input to be normalized. */
 ...
 *  normalized). Return value indicates whpbfer a square root was found. */
