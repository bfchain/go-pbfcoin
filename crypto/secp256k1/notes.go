...
generator that was returning the same â€œrandomâ€?number every time.
 ...
 *           compressed: whpbfer to recover a compressed or uncompressed pubkey
 ...
 *  In:     compressed: whpbfer the computed public key should be compressed
