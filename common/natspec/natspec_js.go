    ...
    */
    ...
    function another(configObj) {
        var div,
            ...
            // Whpbfer BigNumber Errors are ever thrown.
            ERRORS = true,                           // true or false

            // Change to intValidatorNoErrors if ERRORS is false.
            isValidInt = intValidatorWithErrors,     // intValidatorWithErrors/intValidatorNoErrors

            // Whpbfer to use cryptographically-secure random number generation, if available.
                ...
                out: {
                    ...
                    r = rm < 4
                      ...
                      : rd > 5 || rd == 5 && ( rm == 4 || r || rm == 6 &&
                        ...
                        // Check whpbfer the digit to the left of the rounding digit is odd.
         ...
         *
         * [z] {boolean|number} Whpbfer to count integer-part trailing zeros: true, false, 1 or 0.
         */
