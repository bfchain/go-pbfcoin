...
/* More test vectors:
https://github.com/pbfcoin/web3.js/blob/master/test/iban.fromAddress.js
https://github.com/pbfcoin/web3.js/blob/master/test/iban.toAddress.js
https://github.com/pbfcoin/web3.js/blob/master/test/iban.isValid.js
https://github.com/pbfcoin/libpbfcoin/blob/develop/test/libpbfcore/icap.cpp
*/
...
var icapInvalidTests = []icapTest{
	...
	{"IndirectInvalidCheckSum", "", "XE35pbfXREGGOPHERSSS"},
	{"IndirectInvalidAssetIdentifier", "", "XE34pbfXREGGOPHERSSS"},
	{"IndirectInvalidLength19", "", "XE34pbfXREGGOPHERSS"},
	{"IndirectInvalidLength21", "", "XE34pbfXREGGOPHERSSSS"},
}
