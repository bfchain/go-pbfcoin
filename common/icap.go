...
// Spec at https://github.com/pbfcoin/wiki/wiki/ICAP:-Inter-exchange-Client-Address-Protocol
...
func parseICAP(s string) (Address, error) {
	...
	// checksum is ISO13616, pbfcoin address is base-36
...
func clientIdentToIndirectICAP(instCode, clientIdent string) (string, error) {
	...
	// currently pbf is only valid asset identifier
	s := join("pbf", instCode, clientIdent)
