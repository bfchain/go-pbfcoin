...
[![Build
Status](https://travis-ci.org/pbfcoin/go-pbfcoin.png?branch=master)](https://travis-ci.org/pbfcoin/go-pbfcoin)

The common package contains the pbfcoin utility library.

# Installation

As a subdirectory the main go-pbfcoin repository, you get it with
`go get github.com/pbfcoin/go-pbfcoin`.

# Usage

## RLP (Recursive Linear Prefix) Encoding

RLP Encoding is an encoding scheme used by the pbfcoin project. It
encodes any native value or list to a string.

More in depth information about the encoding scheme see the
[Wiki](http://wiki.pbfcoin.org/index.php/RLP) article.
...
Patricie Tree is a merkle trie used by the pbfcoin project.

More in depth information about the (modified) Patricia Trie can be
found on the [Wiki](http://wiki.pbfcoin.org/index.php/Patricia_Tree).
